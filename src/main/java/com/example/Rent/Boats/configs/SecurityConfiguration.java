    ...
    public class SecurityConfiguration  {
        ...
        public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
            http
                    ...
                    .authorizeHttpRequests((requests) -> requests
                            ...
                            .requestMatchers("/barche/**").permitAll()
                            ...
                            .requestMatchers("/barche/{id}/image").permitAll()
        ...
        public void securityFilterChain(WebSecurity web) {
            web
                    .ignoring()
                    .requestMatchers("/resources/**"); // Ignora la sicurezza per le risorse statiche se necessario
        }
        ...
        CorsConfigurationSource corsConfigurationSource() {
            ...
            configuration.setAllowedHeaders(List.of("Authorization", "Content-Type","Roles"));
